 ...
 */
export declare type ExplainStats = {
    /**
 ...
 */
export declare type ClusterImbalanceInfo = {
    /**
 ...
 */
export declare type ClusterRebalanceState = ClusterImbalanceInfo & {
    /**
 ...
 */
export declare type ClusterRebalanceOptions = {
    /**
...
export declare type ClusterRebalanceMove = {
    /**
...
export declare type ClusterRebalanceResult = {
    /**
 ...
 */
export declare type MultiServiceDependency = {
    /**
     * Whether this is a multi-service dependency.
     */
    multiple: true;
 ...
 */
export declare type ServiceTestStats = {
    /**
 ...
 */
export declare type ServiceTestStreamTest = {
    title: string;
    fullTitle: string;
    duration: number;
    err?: string;
 ...
 */
export declare type ServiceTestStreamReport = (["start", {
    total: number;
 ...
 */
export declare type ServiceTestSuiteTest = {
 ...
 */
export declare type ServiceTestSuite = {
    title: string;
 ...
 */
export declare type ServiceTestSuiteReport = {
 ...
 * representation.
 */
export declare type ServiceTestXunitTest = ["testcase", {
    classname: string;
    name: string;
    time: number;
}] | [
 ...
 */
export declare type ServiceTestTapReport = string[];
/**
 * Test results for a single test case using the default reporter.
 */
export declare type ServiceTestDefaultTest = {
    title: string;
    fullTitle: string;
    duration: number;
    err?: string;
 ...
 */
export declare type SwaggerJson = {
    [key: string]: any;
    info: {
        title: string;
        description: string;
 ...
 */
export declare type AccessLevel = "rw" | "ro" | "none";
/**
 * Properties of an ArangoDB user object.
 */
export declare type ArangoUser = {
    /**
 ...
 */
export declare type UserAccessLevelOptions = {
    /**
 ...
 */
export declare type QueueTimeMetrics = {
    /**
 ...
 */
export declare type HotBackupOptions = {
    /**
 ...
 */
export declare type HotBackupResult = {
    id: string;
 ...
 */
export declare type HotBackupList = {
    server: string;
 ...
 */
export declare type LogLevelLabel = "FATAL" | "ERROR" | "WARNING" | "INFO" | "DEBUG";
/**
 * Logging level setting.
 */
export declare type LogLevelSetting = LogLevelLabel | "DEFAULT";
/**
 * Log sorting direction, ascending or descending.
 */
export declare type LogSortDirection = "asc" | "desc";
/**
 * Options for retrieving log entries.
 */
export declare type LogEntriesOptions = {
    /**
 ...
 */
export declare type LogEntries = {
    totalAmount: number;
    lid: number[];
    topic: string[];
    level: LogLevel[];
...
declare type TrappedError = {
    error: true;
};
declare type TrappedRequest = {
    error?: false;
    jobId: string;
...
export declare class Database {
     ...
     * ```
     */
    computeClusterRebalance(opts: ClusterRebalanceOptions): Promise<ClusterRebalanceResult>;
    /**
     ...
     * ```
     */
    rebalanceCluster(opts: ClusterRebalanceOptions): Promise<ClusterRebalanceResult>;
    /**
     ...
     * ```
     */
    createCollection<T extends Record<string, any> = any>(collectionName: string, options?: CreateCollectionOptions & {
     ...
     * ```
     */
    createEdgeCollection<T extends Record<string, any> = any>(collectionName: string, options?: CreateCollectionOptions): Promise<EdgeCollection<T>>;
    /**
     ...
     * ```
     */
    createAnalyzer(analyzerName: string, options: CreateAnalyzerOptions): Promise<Analyzer>;
    /**
     ...
     * ```
     */
    getUserAccessLevel(username: string, { database, collection }: UserAccessLevelOptions): Promise<AccessLevel>;
    /**
     ...
     * ```
     */
    executeTransaction(collections: TransactionCollections & {
        allowImplicit?: boolean;
    }, action: string, options?: TransactionOptions & {
        params?: any;
    }): Promise<any>;
    /**
     ...
     * ```
     */
    executeTransaction(collections: (string | ArangoCollection)[], action: string, options?: TransactionOptions & {
        params?: any;
    }): Promise<any>;
    /**
     * Performs a server-side transaction and returns its return value.
     ...
     * ```
     */
    executeTransaction(collection: string | ArangoCollection, action: string, options?: TransactionOptions & {
        params?: any;
    }): Promise<any>;
    /**
     ...
     * ```
     */
    beginTransaction(collection: string | ArangoCollection, options?: TransactionOptions): Promise<Transaction>;
    /**
     ...
     * ```
     */
    withTransaction<T>(collections: TransactionCollections, callback: (step: Transaction["step"]) => Promise<T>, options?: TransactionOptions): Promise<T>;
    /**
     * Begins and commits a transaction using the given callback. Individual
     * requests that are part of the transaction need to be wrapped in the step
     * function passed into the callback. If the promise returned by the callback
     ...
     * ```
     */
    withTransaction<T>(collections: (string | ArangoCollection)[], callback: (step: Transaction["step"]) => Promise<T>, options?: TransactionOptions): Promise<T>;
    /**
     * Begins and commits a transaction using the given callback. Individual
     * requests that are part of the transaction need to be wrapped in the step
     * function passed into the callback. If the promise returned by the callback
     ...
     * ```
     */
    withTransaction<T>(collection: string | ArangoCollection, callback: (step: Transaction["step"]) => Promise<T>, options?: TransactionOptions): Promise<T>;
    /**
     ...
     * ```
     */
    installService(mount: string, source: Readable | Buffer | Blob | string, options?: InstallServiceOptions): Promise<ServiceInfo>;
    /**
     ...
     * ```
     */
    replaceService(mount: string, source: Readable | Buffer | Blob | string, options?: ReplaceServiceOptions): Promise<ServiceInfo>;
    /**
     ...
     * ```
     */
    upgradeService(mount: string, source: Readable | Buffer | Blob | string, options?: UpgradeServiceOptions): Promise<ServiceInfo>;
    /**
     ...
     * ```
     */
    uninstallService(mount: string, options?: UninstallServiceOptions): Promise<void>;
    /**
     ...
     * ```
     */
    setLogLevel(levels: Record<string, LogLevelSetting>): Promise<Record<string, LogLevelSetting>>;
    /**
